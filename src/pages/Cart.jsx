...
import cartBg from "../assets/about/mission1.jpg";
    ...
    <>
      ...
      <div className="font-poppins">
        <div
          ...
          className="flex items-center justify-center text-[70px] font-serif text-white h-[350px] bg-top bg-cover bg-no-repeat"
        >
          CART
        </div>
        <div
                ...
                <div className="flex items-center justify-between w-full py-4 px-2 sm:p-4">
                  ...
                  <button className="flex gap-4 sm:gap-12 px-2 py-2 border text-[.8rem] text-[#999]">
                    ...
                    <span className="flex items-center gap-4">
                      <IoMdArrowDropleft
                        onClick={() => reduceProductQuantity(cartItem.name)}
                      />
                      <span>{cartItem.quantity}</span>
                      <IoMdArrowDropright
                        onClick={() => addProductQuantity(cartItem.name)}
                      />
                    </span>
                  </button>
                  ...
                  <RxCross2 onClick={() => removeFromCart(cartItem.name)} />
                </div>
